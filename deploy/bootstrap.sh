...
SI_BUILD_IMAGE="${SI_BUILD_IMAGE:-ghcr.io/autowarefoundation/autoware-safety-island:devcontainer}"
...
nvidia-smi >/dev/null
required_gib=2
docker image inspect carlasim/carla:0.9.16 >/dev/null 2>&1 || ((required_gib += 20))
docker image inspect ghcr.io/autowarefoundation/autoware:universe-20250207 >/dev/null 2>&1 || ((required_gib += 15))
...
docker pull ghcr.io/autowarefoundation/autoware:universe-20250207
docker compose \
